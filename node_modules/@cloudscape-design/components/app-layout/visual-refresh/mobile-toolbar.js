...
export default function MobileToolbar() {
    ...
    return (React.createElement("section", { className: clsx(styles['mobile-toolbar'], [testutilStyles['mobile-bar']], {
        ...
        !navigationHide && (React.createElement("nav", { "aria-hidden": navigationOpen, className: clsx(styles['mobile-toolbar-nav'], { [testutilStyles['drawer-closed']]: !navigationOpen }) },
