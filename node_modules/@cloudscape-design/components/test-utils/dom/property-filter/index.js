...
exports.PropertyFilterEditorDropdownWrapperInternal = exports.FilteringGroupedTokenWrapper = exports.FilteringTokenWrapperInternal = exports.PropertyFilterWrapperInternal = exports.PropertyFilterEditorDropdownWrapper = exports.FilteringTokenWrapper = void 0;
...
class PropertyFilterWrapperInternal extends PropertyFilterWrapper {
    findTokens() {
        return this.findAllByClassName(FilteringTokenWrapperInternal.rootSelector).map((elementWrapper) => new FilteringTokenWrapperInternal(elementWrapper.getElement()));
    }
}
exports.PropertyFilterWrapperInternal = PropertyFilterWrapperInternal;
class FilteringTokenWrapperInternal extends FilteringTokenWrapper {
    findEditorDropdown(options = { expandToViewport: false }) {
        const root = options.expandToViewport ? (0, dom_1.createWrapper)() : this;
        const popoverBody = root.findByClassName(styles_selectors_js_2.default.body);
...
exports.FilteringTokenWrapperInternal = FilteringTokenWrapperInternal;
...
class PropertyFilterEditorDropdownWrapperInternal extends PropertyFilterEditorDropdownWrapper {
...
exports.PropertyFilterEditorDropdownWrapperInternal = PropertyFilterEditorDropdownWrapperInternal;
