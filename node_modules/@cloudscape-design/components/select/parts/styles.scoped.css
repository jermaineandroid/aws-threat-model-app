...
.awsui_placeholder_dwuol_x68fs_141:not(#\9) {
  color: var(--color-text-input-placeholder-mx1ygd, #5f6b7a);
  font-style: italic;
}

.awsui_item_dwuol_x68fs_146:not(#\9) {
  display: flex;
  align-items: center;
}
.awsui_item_dwuol_x68fs_146 > .awsui_checkbox_dwuol_x68fs_150:not(#\9) {
  position: relative;
...
.awsui_filter_dwuol_x68fs_159:not(#\9) {
  z-index: 4;
  flex-shrink: 0;
}

.awsui_trigger_dwuol_x68fs_164:not(#\9) {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}

.awsui_layout-strut_dwuol_x68fs_170:not(#\9) {
  inline-size: 100%;
  position: relative;
  transform: translate3d(0, 0, 0);
}

.awsui_list-bottom_dwuol_x68fs_176:not(#\9) {
  /* used in unit-tests */
}

.awsui_selected-icon_dwuol_x68fs_180:not(#\9) {
  color: var(--color-border-item-focused-b2ntyl, #0972d3);
}

.awsui_show-label-tag_dwuol_x68fs_184 > .awsui_selected-icon_dwuol_x68fs_180:not(#\9) {
  padding-inline-start: var(--space-scaled-s-aqzyko, 12px);
}

.awsui_inline-token-trigger_dwuol_x68fs_188:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
...
.awsui_inline-token-list_dwuol_x68fs_195:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
.awsui_inline-token-list_dwuol_x68fs_195:not(#\9):dir(rtl) {
  -webkit-mask-image: linear-gradient(-270deg, transparent, white 20px, white);
          mask-image: linear-gradient(-270deg, transparent, white 20px, white);
}
.awsui_inline-token-list_dwuol_x68fs_195 > .awsui_inline-token_dwuol_x68fs_188:not(#\9) {
  display: flex;
  align-items: center;
...
.awsui_visual-refresh_dwuol_x68fs_225 > .awsui_inline-token-list_dwuol_x68fs_195 > .awsui_inline-token_dwuol_x68fs_188:not(#\9) {
...
.awsui_inline-token-hidden-placeholder_dwuol_x68fs_232:not(#\9) {
  position: absolute !important;
  inset-block-start: -9999px !important;
  inset-inline-start: -9999px !important;
}

.awsui_inline-token-counter_dwuol_x68fs_238:not(#\9) {
  white-space: nowrap;
}

.awsui_inline-token-trigger--disabled_dwuol_x68fs_242 > .awsui_inline-token-list_dwuol_x68fs_195 > .awsui_inline-token_dwuol_x68fs_188:not(#\9) {
  border-color: var(--color-border-control-disabled-bv2kkn, #d1d5db);
  background-color: var(--color-background-container-content-4un1ap, #ffffff);
  color: var(--color-text-disabled-f4c52h, #9ba7b6);
}

.awsui_inline-label-trigger-wrapper_dwuol_x68fs_248:not(#\9) {
  margin-block-start: -7px;
}

.awsui_inline-label-wrapper_dwuol_x68fs_252:not(#\9) {
  margin-block-start: calc(var(--space-scaled-xs-26e2du, 8px) * -1);
}

.awsui_inline-label_dwuol_x68fs_248:not(#\9) {
...
.awsui_inline-label_dwuol_x68fs_248.awsui_inline-label-disabled_dwuol_x68fs_274:not(#\9) {
...
.awsui_disabled-reason-tooltip_dwuol_x68fs_282:not(#\9) {
